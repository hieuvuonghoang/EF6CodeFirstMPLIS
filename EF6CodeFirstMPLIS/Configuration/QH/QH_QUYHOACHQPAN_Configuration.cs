...
{ 
	...
	public class QH_QUYHOACHQPAN_Configuration : EntityTypeConfiguration<QH_QUYHOACHQPAN> 
	{ 
		public QH_QUYHOACHQPAN_Configuration() 
		{ 
			this.HasKey(t => t.QUYHOACHQPANID); 
