...
{ 
	...
	public class QH_QUYHOACHCAPHUYEN_Configuration : EntityTypeConfiguration<QH_QUYHOACHCAPHUYEN> 
	{ 
		public QH_QUYHOACHCAPHUYEN_Configuration() 
		{ 
			this.HasKey(t => t.QUYHOACHCAPHUYENID); 
			...
			this.ToTable("QH_QUYHOACHCAPHUYEN"); 
		} 
	} 
}