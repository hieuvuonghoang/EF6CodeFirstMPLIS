...
{ 
	...
	public class QH_QUYHOACHCAPTW_Configuration : EntityTypeConfiguration<QH_QUYHOACHCAPTW> 
	{ 
		public QH_QUYHOACHCAPTW_Configuration() 
		{ 
			this.HasKey(t => t.QUYHOACHCAPTWID); 
